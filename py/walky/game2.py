...
class enemy(object):
    ...
    def draw(self, win):
        ...
        if self.walkCount + 1 >= 33: # Since we have 11 images for each animtion our upper bound is 33. 
            ...
            self.walkCount = 0      # reset to 0.  why isn't this done in a for loop??? is this pythonic
...
goblin = enemy(100, 400, 64, 63, 300)
